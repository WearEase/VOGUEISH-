...
export default function NavbarIcons() {
  ...
  return (
    <div className="flex space-x-6 items-center">
      ...
      <Link
        href="/cart"
        className="relative p-2 text-black rounded-full hover:bg-gray-100 transition-colors group"
      >
      ...
      <div className="relative">
        <button
          ...
          className="p-2 text-black rounded-full hover:bg-gray-100 transition-colors flex items-center justify-center"
        ...
        {isMenuOpen && (
          <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl py-2 z-50 text-sm">
            <Link
