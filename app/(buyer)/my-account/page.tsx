    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {!isAuthed ? (
          ...
          <section id="my-orders" className="lg:col-span-2 bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <div className="p-6 sm:p-8 border-b border-gray-200 flex items-start justify-between gap-4 flex-wrap">
              <div>
                <h2 className="text-2xl font-semibold text-gray-900">My Orders</h2>
                <p className="mt-2 text-gray-600">
                  Track recent purchases and jump back into tailoring when you need a better fit.
                </p>
              </div>
              <Link
                href="/my-orders"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200 text-sm text-gray-900 hover:bg-gray-50 transition"
              >
                View all orders
                <ChevronRight className="w-4 h-4" />
              </Link>
                ...
                <div key={order.id} className="p-6 sm:p-8 flex flex-col gap-5">
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    <div>
                      ...
                      <h3 className="mt-1 text-lg font-semibold text-gray-900">{order.id}</h3>
